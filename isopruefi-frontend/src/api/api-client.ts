...
export class LocationClient {
    ...
    getCoordinates(postalCode: number): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/v1/Location/GetCoordinates/{postalCode}";
        if (postalCode === undefined || postalCode === null)
            throw new globalThis.Error("The parameter 'postalCode' must be defined.");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetCoordinates(_response);
        });
    }

    protected processGetCoordinates(response: Response): Promise<FileResponse> {
    ...
    showAvailableLocations(): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/v1/Location/ShowAvailableLocations";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processShowAvailableLocations(_response);
        });
    }

    protected processShowAvailableLocations(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class TemperatureDataClient {
    ...
    getTemperature(start?: Date | undefined, end?: Date | undefined, place?: string | undefined, isFahrenheit?: boolean | undefined): Promise<TemperatureDataOverview> {
        ...
        if (place === null)
            throw new globalThis.Error("The parameter 'place' cannot be null.");
        else if (place !== undefined)
            url_ += "place=" + encodeURIComponent("" + place) + "&";
        if (isFahrenheit === null)
            throw new globalThis.Error("The parameter 'isFahrenheit' cannot be null.");
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.sensorData)) {
            ...
            for (let item of this.sensorData)
                data["sensorData"].push(item ? item.toJSON() : undefined as any);
        }
        if (Array.isArray(this.temperatureOutside)) {
            data["temperatureOutside"] = [];
            for (let item of this.temperatureOutside)
                data["temperatureOutside"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.temperatureDatas)) {
            ...
            for (let item of this.temperatureDatas)
                data["temperatureDatas"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
...
export class TopicSetting implements ITopicSetting {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.coordinateMapping = _data["coordinateMapping"] ? CoordinateMapping.fromJS(_data["coordinateMapping"]) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["coordinateMapping"] = this.coordinateMapping ? this.coordinateMapping.toJSON() : undefined as any;
...
export class CoordinateMapping implements ICoordinateMapping {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.lastUsed = _data["lastUsed"] ? new Date(_data["lastUsed"].toString()) : undefined as any;
    ...
    toJSON(data?: any) {
        ...
        data["lastUsed"] = this.lastUsed ? this.lastUsed.toISOString() : undefined as any;
